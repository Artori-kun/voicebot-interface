...
<!--    <script>-->
<!--      $('#audio').html(<audio autoPlay><source src="192.168.134.178:8888/output.wav" /></audio>);-->
<!--    </script>-->
<!--    <span id="response-voice"></span>-->
		<audio id="response-voice" crossorigin="anonymous" preload="none" type="audio/wav"
...
// $('#response-voice').html('<audio autoplay><source :src="getCurrentIncomingMessage.link"></audio>');
...
export default {
	...
	sockets: {
		...
		bot_uttered(data) {
			console.log(data);
			if (data.text) { this.$store.commit('addOutgoingMessage', { text: data.text }); }
